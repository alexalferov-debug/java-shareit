...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto createBooking(CreateBookingDto bookingDto, Long userId) {
        ...
        if (item.getOwner().getId().equals(userDTO.getId())) {
    ...
    public BookingDto updateBookingStatus(int bookingId, boolean status, Long userId) {
    ...
    public BookingDto getBooking(int bookingId, Long userId) {
        Booking booking = storage.getBooking(bookingId);
        if (booking == null) {
            throw new NotFoundException("Booking not found");
        }
    ...
    public List<BookingDto> getBookings(Long userId, BookingState state, boolean isForOwner) {
    ...
    public List<Booking> getFinishedBookings(List<Long> items) {
        return storage.getFinishedBookings(items);
    }

    public List<Booking> getNextBookings(List<Long> items) {
